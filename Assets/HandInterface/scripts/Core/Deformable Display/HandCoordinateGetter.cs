...
namespace HPUI.Core
{
    ...
    public class HandCoordinateGetter : MonoBehaviour
    {
	...
	GameObject index3;
	public static GameObject index4;

	public static GameObject middle1;
	GameObject middle2;
	GameObject middle3;
	public static GameObject middle4;

	public static GameObject ring1;
	GameObject ring2;
	GameObject ring3;
	GameObject ring4;

	public static GameObject pinky1;
	GameObject pinky2;
	GameObject pinky3;
	GameObject pinky4;

	public static GameObject palmBottom;
	...
	public static List<Vector3> calibrationKeypoints;
	public static List<Vector3> keypointDifferences;
	private static List<GameObject> keypointObjects;

	public static List<Vector3> undeformedVerticesCoordinates = new List<Vector3>();

	//public static List<Vector3> xDifferenceVectors = new List<Vector3>();
	//public static List<Vector3> yDifferenceVectors = new List<Vector3>();
	//public static List<Vector3> zDifferenceVectors = new List<Vector3>();
	public static double[,] xDifferenceVectors;
	public static double[,] yDifferenceVectors;
	public static double[,] zDifferenceVectors;
	public static double[,] xyzDifferenceVectors;

	//indices of POI for computing calibration width/height of display
	// static int middleFingerTipIndex = 7;
	// static int palmBaseIndex = 16;
	// static int indexFingerTipIndex = 3;
	// static int pinkyTipIndex = 15;
	// static int middleFingerBottomIndex = 4;
	...
	public static Vector3 MidpointCalculation(Vector3 point1, Vector3 point2)
	{
